...
void ActionManager::Init(IrosState* state)
{
    ...
    ActionDescription *release_can = new ActionDescription;
    release_can->actionType = release_canAction;
    release_can->actionId = id++;
    ActionManager::actions.push_back(release_can);
...
std::string Prints::PrintObs(int action, int obs)
{
    ...
    std::string Prints::PrintActionType(ActionType actType)
    {
        ...
        case release_canAction:
            return "release_canAction";
...
std::string Prints::GetStateJson(State& _state)
    {
        ...
        j["drinkServedOpenHand"] = state.drinkServedOpenHand;
    ...
    void Prints::GetStateFromJson(IrosState& state, std::string jsonStr, int stateIndex)
    {
        ...
        state.drinkServedOpenHand = j[stateIndex]["drinkServedOpenHand"];

#ifndef ENUM_MAP_ICAPS3_H
#define ENUM_MAP_ICAPS3_H
  ...
  enum ActionType
{
  ...
  enum Icaps3ResponseModuleAndTempEnums
  {
  ...
  struct enum_map_icaps3
  {
	  static map<Icaps3ResponseModuleAndTempEnums,std::string> CreateMapResponseEnumToString()
	  {
          map<Icaps3ResponseModuleAndTempEnums,std::string> m;
		...
		static map<std::string, Icaps3ResponseModuleAndTempEnums> CreateMapStringToEnum(map<Icaps3ResponseModuleAndTempEnums,std::string> vecResponseEnumToString)
	  {
          map<std::string, Icaps3ResponseModuleAndTempEnums> m;
		  map<Icaps3ResponseModuleAndTempEnums,std::string>::iterator it;
    ...
    static map<Icaps3ResponseModuleAndTempEnums,std::string> vecResponseEnumToString;
	static map<std::string, Icaps3ResponseModuleAndTempEnums> vecStringToResponseEnum;
	static map<ActionType,std::string> vecActionTypeEnumToString;
	static void Init();
  };

} // namespace despot
#endif /* ENUM_MAP_ICAPS3_H */

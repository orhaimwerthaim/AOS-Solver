  ...
  enum ActionType
{
  ...
  enum IrosResponseModuleAndTempEnums
  {
	  ...
	  navigate_failed,
	  release_can_moduleResponse,
	  release_can_eSuccess,
	  release_can_eFailed,
  ...
  struct enum_map_iros
  {
	  static map<IrosResponseModuleAndTempEnums,std::string> CreateMapResponseEnumToString()
	  {
          ...
          m[release_can_eSuccess] = "release_can_eSuccess";
          m[release_can_eFailed] = "release_can_eFailed";
		...
		static map<ActionType,std::string> CreateMapActionTypeEnumToString()
	  {
          ...
          m[release_canAction] = "release_can";
